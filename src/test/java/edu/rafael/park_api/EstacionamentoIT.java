...
public class EstacionamentoIT {
    ...
    @Test
    public void getAllEstacionamentosDoCliente_ComClienteLogado_RetornarDadosComStatus200() {
        PageableDto responseBody = testClient
                .get()
    ...
    @Test
    public void getAllEstacionamentosDoCliente_ComPerfilAdmin_RetornarErrorMessageComStatus403() {
        testClient
                .get()
                .uri("api/v1/estacionamentos/cliente")
                .headers(JwtAuthentication.getHeaderAuthorization(testClient, "adm@email.com", "123456"))
                .exchange()
                .expectStatus().isForbidden()
                .expectBody()
                .jsonPath("status").isEqualTo("403")
                .jsonPath("path").isEqualTo("/api/v1/estacionamentos/cliente")
                .jsonPath("method").isEqualTo("GET");
    }
}
