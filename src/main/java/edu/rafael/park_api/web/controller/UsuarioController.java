...
public class UsuarioController {
    ...
    @Operation(
            ...
            description = "Recurso para buscar um usuário pelo id",
            responses = {
    ...
    @Operation(
            ...
            description = "Recurso para atualizar a senha de um usuário pelo id",
            responses = {
    ...
    @Operation(
            ...
            description = "Recurso para buscar todos os usuários",
            responses = {
